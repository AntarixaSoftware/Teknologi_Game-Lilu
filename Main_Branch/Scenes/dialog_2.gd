...
var dialog_queue: Array = [
	...
	{"name": "Charles", "dialog": "Ucok, kamu tidak takut? Aku saja merinding. Rasanya tempat ini penuh energi aneh, horor kali!" }
]
...
func _ready():
	...
	start.connect("display2", Callable(self, "_on_display2"))
