...
var dialog_queue: Array = [
	{"name": "Charles", "dialog":"Aduh, seram sekali tempat ini. Pohon-pohonnya besar, sunyi pula. Rasanya seperti ada yang mengawasi dari bayangan." },
	{"name": "Charles", "dialog":"Ucok, jangan tinggalkan aku sendiri ya! Aku tidak mau berjalan sendirian di tempat ini." }
]
...
func _ready():
	var start = get_node("/root/Main Scene/Story/Quests/DeepForest/forest")
	start.connect("display3", Callable(self, "_on_display3"))
